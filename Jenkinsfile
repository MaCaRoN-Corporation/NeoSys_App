            ...
            steps {
                script {
                    ...
                    if (VERSION_TYPE == "internal") {
                        ...
                        echo '[!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!]'
                        androidApkUpload googleCredentialsId: 'Google_Play_Store-NeoSys_App', filesPattern: 'Application/Releases/internal_versions/*-release.aab', rolloutPercentage: '100', trackName: 'internal' // internal/alpha/beta/production
